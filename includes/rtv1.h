...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/21 16:42:00 by cbilga            #+#    #+#             */
/*   Updated: 2020/02/04 12:15:40 by cbilga           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				new_sphere(t_win *win, t_sphere **sphere);
...
unsigned int	calculate_light(unsigned int color,
	float light_intensity, float brilliance);
int				get_color_sphere(t_win *win, t_vec3 inter,
	t_sphere *sphere, t_vec3 ray);
int				get_color_plane(t_win *win, t_vec3 inter, t_plane *plane);
int				get_color_cone(t_win *win, t_vec3 inter,
	t_cone *cone, t_vec3 ray);
