...
/*   Updated: 2020/02/04 09:44:42 by cbilga           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "includes/rtv1.h"

static void	get_shadow_color(t_getcolor *c, t_vec3 ray)
{
...
float		dist_sphere(t_vec3 pos, t_vec3 dir, t_sphere *sphere)
{
	...
	t[3] = 2 * (dir.x * (pos.x - sphere->center.x) + dir.y
		* (pos.y - sphere->center.y) + dir.z * (pos.z - sphere->center.z));
